...
class PiperunClient:
    ...
    def create_person(self, name, email, phone, company_name, job_title=''):
    ...
    def create_deal(self, title, person_id, company_id=None, value=0, pipeline_id=None, stage_id=None, notes='', tag=None, origin_id=None):
        ...
        if response.status_code == 201:
            ...
            if result.get('success') and result.get('data'):
                ...
                # Se tem tag, adiciona à oportunidade
                if tag:
